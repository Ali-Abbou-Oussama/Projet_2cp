...
class AlimentsDesignWidgetBreakfast extends StatefulWidget {
  Aliments? model;
  List<Aliments?>? listAliments;
  BuildContext? context;
  double? caloriesAlreadyConsumed;
  AlimentsDesignWidgetBreakfast(
      {Key? key,
      this.model,
      this.listAliments,
      this.context,
  ...
  @override
  State<AlimentsDesignWidgetBreakfast> createState() =>
      _AlimentsDesignWidgetBreakfastState();
}

class _AlimentsDesignWidgetBreakfastState
    extends State<AlimentsDesignWidgetBreakfast> {
